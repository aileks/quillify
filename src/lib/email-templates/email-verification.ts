          ...
          <tr>
            <td style="background-color: ${colors.card}; padding: 40px; border-left: 1px solid ${colors.borderLight}; border-right: 1px solid ${colors.borderLight};">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="center" style="padding: 8px 0 32px 0;">
                    <a href="${verificationUrl}" target="_blank" style="display: inline-block; padding: 16px 36px; background-color: ${colors.primary}; color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 600; border-radius: 8px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; letter-spacing: 0.3px;">
              ...
              <p style="margin: 0 0 16px 0; font-size: 14px; line-height: 22px; color: ${colors.textMuted}; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
                This link will expire in <strong style="color: ${colors.text};">${expiresInHours} hours</strong>.
              </p>
